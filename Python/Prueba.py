...
# Configurar la ventana del turtle
turtle.bgcolor("black")  # Establecer el color de fondo a negro
t = turtle.Turtle()
t.pensize(3)
t.shape("turtle")

# Establecer el color del lápiz a blanco
t.pencolor("white")  # Cambiar el color del lápiz a blanco
...
# Agregar texto
t.penup()
t.goto(-250,240)  # Posicionar el texto en el centro
t.color("White")  # Color del texto
t.write("¡TE AMO CORAZON<3!", align="center", font=("Arial", 16, "bold"))  # Escribir texto
